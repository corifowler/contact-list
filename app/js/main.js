...
var ArtistCollection = _backbone2['default'].Collection.extend({
...
exports['default'] = ArtistCollection;
module.exports = exports['default'];

},{"./artist_model":3,"backbone":8}],3:[function(require,module,exports){
'use strict';
...
var _artist_collection = require('./artist_collection');
...
},{"./ajax_setup":1,"./artist_collection":2,"./router":5,"jquery":9,"moment":10,"underscore":11}],5:[function(require,module,exports){
'use strict';
...
var _viewsArtist_list = require('./views/artist_list');

var _viewsArtist_list2 = _interopRequireDefault(_viewsArtist_list);
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.artists = new _artist_collection2['default']();
  ...
  artistList: function artistList() {
    this.showSpinner();
    console.log('grabbing artists');
    this.artists.fetch().then((function () {

      this.$el.html((0, _viewsArtist_list2['default'])(this.artists.toJSON()));
    }).bind(this));
  },

  showIndividualArtist: function showIndividualArtist(artistId) {
    var _this = this;
    ...
    if (artist) {
      this.$el.html((0, _viewsIndividual_view2['default'])(artist.toJSON()));
    } else {
      (function () {
        var artist = _this.artists.add({ objectId: artistId });
        var router = _this;
        _this.showSpinner();
        artist.fetch().then(function () {
          router.$el.html((0, _viewsIndividual_view2['default'])(artist.toJSON()));
        });
      })();
    }
  },
...
},{"./artist_collection":2,"./views/artist_list":6,"./views/individual_view":7,"backbone":8,"jquery":9}],6:[function(require,module,exports){
'use strict';
